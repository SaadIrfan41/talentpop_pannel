...
const Create_Account_Schema = z
  .object({
    ...
    password: z
      .string()
      .min(2, 'Password must contain at least 2 character(s)')
...
const CreateAccount = () => {
  const [emailRef] = useAutoAnimate(/* optional config */)
  ...
  return (
    <div className=' mx-auto mt-20 max-w-3xl'>
      <h1 className=' mb-10 text-3xl font-bold text-[#69C920]'>
        Create an account
      </h1>
      <form
        //   ref={formRef}
      ...
      >
        ...
        <div ref={emailRef} className=' flex flex-col gap-y-2'>
          <span
            onClick={() => {
        ...
        <div>
          <div className='relative'>
            <input
              ...
              className={`  w-full rounded-lg border border-[#BECDCC]  pr-12 pt-3   pb-4 pl-4 outline-none placeholder:text-lg placeholder:font-normal placeholder:text-[##BECDCC] ${
        ...
        <div>
          <input
            ...
            className={` w-full rounded-lg border border-[#BECDCC]   pt-3   pb-4 pl-4 pr-3 outline-none placeholder:text-lg placeholder:font-normal placeholder:text-[##BECDCC] ${
...

      {
        //@ts-ignore
        errors?.refine && (
          <div className='mt-5  w-full rounded-lg  bg-red-500  pt-3  pb-4 pl-4 text-lg font-normal text-white outline-none'>
            {
              //@ts-ignore
